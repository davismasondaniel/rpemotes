...
Config = {
    ...
    MenuImage = 'https://i.ibb.co/wLYhB7j/1000011521.png', -- You can change the menu image here, please use an image hosted on imgbb.com, GIPHY or a Discord channel / DM with the same width and length. Use a 512 x 128 image!
    ...
    AllowPunching = true, -- Set this to true if you want to allow people punching while emotes are playing
    AllowedInCars = true, -- Set this false if you want to disable emotes in cars.
    AllowInWater = true, -- If turned off, opening the menu and playing an emote will not be possible while swimming.
